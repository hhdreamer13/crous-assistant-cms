export const data = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        bullets: [
          `<span class="text-yellow-300">assistance-izly@crous-paris.fr</span>`,
          `<span class="text-yellow-300">assistance-izly@crous-creteil.fr / support.izly@crous-créteil.fr</span>`,
          `<span class="text-yellow-300">assistance-izly@crous-versailles.fr</span>`,
        ],
      },
      {
        id: 5,
...
`,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        id: 18,
        title: "Refus du complément grandes vacances",
        text: "Vous êtes en fin de cursus, vous pourrez bénéficier du complément grandes vacances lorsque vous nous aurez déposé votre certificat de scolarité 22/23 dans votre dossier social étudiant 21/22.",
        bullets: [
