export const data = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        title: "Justificatifs",
        text: ``,
        bullets: ["Relevé de notes du baccalauréat"],
      },
      {
        id: 4,
        title: "Notes",
  ...
  {
    id: 2,
    title: "Aide au Mérite Régionale",
    paragraphs: [
      {
        id: 1,
        title: "",
        text: `Cette aide est versée aux étudiants ayant obtenu la mention TB au baccalauréat en Ile de France et s’inscrivant dans l’enseignement supérieur toujours en IDF. Gestion hors DSE, pas de possibilité de suivi. Le paiement de cette aide sera réalisé entre janvier et mai de l’année N. Versée en une seule mensualité de 1000 euros. L’étudiant n’a pas de démarches à effectuer. Le Crous peut lui demander de justifier de pièces complémentaires via l’envoi d’un mail (pas de visibilité possible sur le fil AGLAE) l’étudiant répond par retour mail directement.`,
        bullets: [],
      },
      {
        id: 2,
    ...
    paragraphs: [
      {
        id: 1,
        title: "",
        text: `Les étudiants boursiers n'ayant pas achevé leurs études au 1er juillet de l'année universitaire au titre de laquelle ils ont obtenu une bourse peuvent continuer à recevoir leur bourse pendant les grandes vacances s'ils se trouvent dans l'une des situations ci-dessous.`,
        bullets: [],
      },
      {
        id: 1,
      ...
      },
      {
        ...
        bullets: [
          ...
          "Si l’étudiant en BTS 2, licence 3 ou en master 2, il faut justifier d’une continuité dans ses études avec un certificat de scolarité.",
        ],
      },
      {
        id: 1,
