...
const BoursePaiementCategoryDetails = () => {
  const data = [
    {
      id: 1,
    ...
    {
      id: 2,
      title: "Étudiant dans un pays membre du Conseil de l’Europe",
      paragraphs: [
        {
          id: 1,
          title: "",
    ...
    {
      id: 4,
      title: "Refus et Suspenstion de la bourse",
      paragraphs: [
        {
          id: 1,
          title: "",
...
export default BoursePaiementCategoryDetails;
